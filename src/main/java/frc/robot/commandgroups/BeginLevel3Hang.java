...
public class BeginLevel3Hang extends CommandGroup {
  ...
  public BeginLevel3Hang() {
    addParallel(new PushDownFrontPID(Constants.pushDownFrontPreset));
    addSequential(new WaitOnHangFrontTarget(2));
    addParallel(new PushDownBackPID(Constants.pushDownBackPreset));
    addSequential(new WaitOnHangBackTarget(Constants.pushDownBackPreset));
